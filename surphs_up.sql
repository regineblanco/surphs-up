...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 03, 2017 at 10:47 AM
...
(4, 'Kermit Surf Resort and Restaurant', 'Want some Italian by the beach? Look no further! This restaurant offers sumptuous meals and mouth watering desserts.', 'Purok 5, General Luna, Siargao Island, Philippines, General Luna, 8417', 'Italian, American', 'P200-P1000', 4),
(5, 'Art Cafe', 'A family-friendly restaurant that turns into a chill bar with good live music at night. One simply cannot go to El Nido without trying this out.', 'Barangay Buena Suerte, El Nido, Palawan', 'Filipino, American, Mexican, Turkish', 'P300-P5000', 5),
(13, 'Tambayan', 'Perfect for groups of people, insanely dee-lish Filipino dishes!', 'Gov. Luna St, San Fernando, La Union', 'Filipino, American', 'P200-1000', 2),
...
(28, 'gallery/zamba2.jpg', 1, NULL),
(29, 'gallery/lu3.jpg', 2, NULL),
(30, 'gallery/baler3.jpeg', 3, NULL),
(32, 'gallery/siargao2.jpg', 4, NULL),
(33, 'gallery/zamba.jpg', 5, NULL);
...
(1, 'Circle Hostel', 'Friendly faces everywhere, artsy vibes, painted walls, board games, and unli beer. Probably the best budget hostel around!', 'Sito Liwliwa, San Felipe Zambales, San Felipe, Zambales', 'P450-1500', 1),
(2, 'Flotsam and Jetsam', 'This takes hostels to a whole new level. The place screams chic and chill at the same time. By day the patio is a restaurant, by night, a movie house with lanterns, mats, and cocktails in your hands.', 'MacArthur Highway, San Juan, La Union', 'P700-P3000', 2),
(3, 'Nalu Surf Camp', 'When you want to up your staying experience in Baler, this is one of your best bets. Situated just right in front of Sabang Beach, with a large patio where you can walk your dog around too. Very family-friendly.', 'Sabang Beach, Baler, Aurora', 'P2,000-P10,000', 3),
(4, 'The Smiling Pig Hostel', 'Quirky name and quirky place, once you''ve tried staying here you''ll be sure to come back for more!', 'General Luna, Surigao del Norte', 'P200-P700', 4),
(5, 'RicGem Place', 'Super chill, clean, neat, no-nonsense family-owned hotel. This is the place to be when you want a nice place to stay with accommodating and friendly staff!', 'Baracalan El Nido, 5313, Osmeña St, Barangay Buena Suerte, El Nido, Palawan', 'P3,000-P10,000', 5),
(15, 'Circle Hostel', 'Friendly people everywhere, awesome chill vibes, free peanut butter and banana breakfast, perfect place for budget travellers.', 'Barangay Urbiztondo, San Juan, 2514 La Union', 'P500-P1100', 2),
(16, 'Vessel Hostel', 'Newly-opened, this hostel is made of little rooms that look like shipping containers, so cool.', 'Urbiztondo, Manila N Rd, San Juan, La Union', 'P500-P2000', 2);
...
(39, 'Hotness Overload', 'hotnessoverload@yahoo.com', 'hotnessoverload', '9a76a857ad399b492ba01879d0fa2d717e4430b2', 'regular'),
(46, 'Vincent Pleyto', 'vince@msn.com', 'hotnessoverload', '9a76a857ad399b492ba01879d0fa2d717e4430b2', 'regular');
